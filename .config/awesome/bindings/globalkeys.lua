-- Standard awesome libraryusing increment/decrement
...
local modkey = _G.user_vars.modkey
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    -- Changing master client width/height using increment/decrement
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    -- Selection of layouts/ max/min window
